export const regexMap = {
  ...
  quotation: '(?<quotation>")',
  hexCommand: "(?<hexCommand>\\$(?<hexCommandValue>[a-fA-F\\d]*))",
  hexSubLoop: "(?<hexSubLoop>\\$[e|E]6\\s*\\$(?<hexSubLoopValue>[a-fA-F\\d]*))",
  quantization: "(?<quantization>[qQ](?<quantizationValue>[a-fA-F\\d]*))",
  noise: "(?<noise>[nN](?<noiseValue>[a-fA-F\\d]*))",
