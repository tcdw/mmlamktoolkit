export const regexMap = {
  ...
  quotation: '(?<quotation>")',
  hexCommand: "(?<hexCommand>\\$(?<hexCommandValue>[a-fA-F\\d]{,2}))",
  hexSubLoop: "(?<hexSubLoop>\\$[e|E]6\\s*\\$(?<hexSubLoopValue>[a-fA-F\\d]{,2}))",
  quantization: "(?<quantization>[qQ](?<quantizationValue>[a-fA-F\\d]{,2}))",
  noise: "(?<noise>[nN](?<noiseValue>[a-fA-F\\d]{,2}))",
